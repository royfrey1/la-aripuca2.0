  ...
  return (
    <section className="max-w-7xl mx-auto px-8 py-24">
      <div className="flex flex-col items-center text-center mb-12">
        <h2 className="text-5xl font-black text-white tracking-tighter italic">VIDEO TOUR</h2>
        <p className="text-emerald-400 font-mono text-sm mt-2">/ siente la experiencia</p>
      </div>
